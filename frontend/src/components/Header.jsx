...
const Header = () => {
  ...
  return (
    <header className="bg-dark-neu-300 shadow-dark-neu-lg sticky top-0 z-50 border-b border-dark-neu-500">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-8 py-1">
        <div className="flex items-center justify-between relative">
          ...
          <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2">
            <div className="text-center">
              <p className="text-xs lg:text-sm text-white font-bold tracking-wide whitespace-nowrap">
                Fair Mediador
              </p>
              <p className="text-[10px] lg:text-xs text-white font-semibold tracking-wide opacity-80 whitespace-nowrap">
