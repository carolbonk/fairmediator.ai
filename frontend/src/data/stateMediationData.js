// State mediation law and mediator qualification standards
// This data should eventually come from your backend API

export const stateMediationData = {
  FL: {
    stateName: 'Florida',
    stateCode: 'FL',
    mediationStatute: {
...
// Helper function to get state data (defaults to Florida if not found)
export const getStateMediationData = (stateCode) => {
  return stateMediationData[stateCode] || stateMediationData.FL;
};

// Get list of supported states
export const getSupportedStates = () => {
  return Object.keys(stateMediationData);
};
